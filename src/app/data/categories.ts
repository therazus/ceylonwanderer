  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      locations: [
        ...
        { id: "nuwara-eliya", name: "Nuwara Eliya / Gregory Lake", category: "adventure", coordinates: { x: 51, y: 71 } },
        { id: "sigiriya-adventure", name: "Sigiriya & Pidurangala", category: "adventure", coordinates: { x: 52, y: 48 } },
        { id: "adams-peak", name: "Adam's Peak (Sri Pada)", category: "adventure", coordinates: { x: 47, y: 74 } },
